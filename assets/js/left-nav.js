  ...
  */
  ...
  var SideNav = (function() {
    ...
    function collapse() {
      ...
      $('i.glyphicon-remove').replaceWith( '<i class="glyphicon glyphicon-plus"></i> ');
    }
    
    function expand() {
      $('body').removeClass('nav-collapsed');
      $('i.glyphicon-plus').replaceWith( '<i class="glyphicon glyphicon-remove"></i> ');
    }
...
$(window).resize(function() {
    $('.main').css("min-height",$(window).height() - 50);
});
